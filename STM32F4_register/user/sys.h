...
//外部晶振频率，更换晶振要改这里啊
#define HSE_CLK     25000000
#define APB1_CLK    SystemCoreClock/4
#define APB2_CLK    SystemCoreClock/2
#define TIM_CLK     APB1_CLK*2
...
void MY_NVIC_GROUP_CONFIG(u8 NVIC_Group);			//设置NVIC分组
